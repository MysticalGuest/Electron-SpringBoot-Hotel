...
//		registry.addInterceptor(checkLoginInterceptor).addPathPatterns("/front/Bill");
		...
		//管理员所有界面拦截
		registry.addInterceptor(checkLoginInterceptor).addPathPatterns("/administrator/CustomerInfoForAdm");
		registry.addInterceptor(checkLoginInterceptor).addPathPatterns("/administrator/IntegratedManagement");
		registry.addInterceptor(checkLoginInterceptor).addPathPatterns("/administrator/ApartmentManageAdm");
		registry.addInterceptor(checkLoginInterceptor).addPathPatterns("/administrator/Account");
		registry.addInterceptor(checkLoginInterceptor).addPathPatterns("/administrator/Statistics");
	}
	@Bean
